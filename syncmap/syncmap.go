// Note:
//   This file is copied from https://github.com/golang/go/blob/master/src/sync/map.go,
//   which will be available from the built-in package "sync/map" since Go 1.9.
//
// Enhancement:
//   Add one more useful method `UpdateOrStore()`.
